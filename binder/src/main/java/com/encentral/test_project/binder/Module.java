...
import com.encentral.test_project.user_management.impl.DefaultCarMaintenanceService;
...
public class Module extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(CarMaintenanceService.class).to(DefaultCarMaintenanceService.class);
